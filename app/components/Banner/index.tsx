        ...
        <div className="grid grid-cols-1 lg:grid-cols-12">
          <div className="col-span-7 flex flex-col justify-evenly relative">
            ...
            <h3 className="text-black opacity-75 text-lg font-normal text-center lg:text-start pt-8">
              Empowering your journey with AI-driven solutions to secure
              globally available opportunities. From Work Visas, to startup
              grants to scholarships to talent opportunities, to conferences and
              events. Seat back and allow the AI search and apply for these
